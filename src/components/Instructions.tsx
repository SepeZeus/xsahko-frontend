...
const Instructions = () => {
  ...
  return (
    <>
      <Header />{" "}
      {/* Keep the Header component outside the instructions container */}
      <div className="instructions-container">
        <div className="instructions">
          ...
          <div className="instruction-step">
            <p>{t("step2")}</p>
            <img
              src="./assets/selectAddressEdited.png"
              alt={t("step2ImgAlt")}
            />
          </div>
          <div className="instruction-step">
            ...
            <img
              src="./assets/selectNrG&DownloadInformation.png"
              alt={t("step3ImgAlt")}
            />
          </div>
          <div className="instruction-step">
            <p>{t("step4")}</p>
            <img
              src="./assets/selectDateAndAccountingPointEdited.png"
              alt={t("step4ImgAlt")}
            />
          </div>
          <div className="instruction-step">
