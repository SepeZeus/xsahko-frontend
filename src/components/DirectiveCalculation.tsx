...
import {
  ValidateFormData,
  ValidationError,
} from "../validation/formDataValidation";
...
const ElectricityPriceForm: React.FC = () => {
  ...
  const [selectedHouseType, setSelectedHouseType] = useState<HouseType | null>(
    null
  );
  const [selectedWorkShiftType, setSelectedWorkshiftType] =
    useState<WorkShiftType | null>(null);
  const [selectedHeatingType, setSelectedHeatingType] =
    useState<HeatingType | null>(null);
            ...
            <div className="form-group">
              ...
              <div>
                <span className="error-message">
                  {
                    validationErrors.find((error) => error.field === "year")
                      ?.message
                  }
                </span>
              </div>
            ...
            <div className="form-group">
              ...
              <div className="input-with-price">
                ...
                <input
                  ...
                  value={formData.directiveFixedPrice}
                  onChange={handleChange}
                  required
                  min={1}
                  step={0.1}
              ...
              <div className="house-type-buttons">
                <button
                  className={`house-type-button ${
                    selectedHouseType === "Apartmenthouse" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHouseType === "Terracedhouse" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHouseType === "Detachedhouse" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHouseType === "Cottage" ? "selected" : ""
                  }`}
          ...
          <>
            ...
            <div className="form-group">
              ...
              <span className="error-message">
                {
                  validationErrors.find(
                    (error) => error.field === "squareMeters"
                  )?.message
                }
              </span>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="work-shift-buttons">
                <button
                  className={`work-shift-button ${
                    formData.workShiftType === "DayWorker" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`work-shift-button ${
                    formData.workShiftType === "ShiftWorker" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`work-shift-button ${
                    formData.workShiftType === "RemoteWorker" ? "selected" : ""
                  }`}
              ...
              <div style={{ textAlign: "center" }}>
                <span className="error-message">
                  {
                    validationErrors.find(
                      (error) => error.field === "workShiftType"
                    )?.message
                  }
                </span>
              </div>
          ...
          <>
            ...
            <div className="form-group">
              <div className="house-type-buttons">
                <button
                  className={`house-type-button ${
                    selectedHeatingType === "ElectricHeating" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHeatingType === "DistrictHeating" ? "selected" : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHeatingType === "GeothermalHeating"
                      ? "selected"
                      : ""
                  }`}
                ...
                <button
                  className={`house-type-button ${
                    selectedHeatingType === "OilHeating" ? "selected" : ""
                  }`}
          ...
          <>
            ...
            <div className="form-group text-center">
              ...
              <Form.Check
                ...
                onChange={() =>
                  setFormData({ ...formData, hasFloorHeating: true })
                }
              />
              <Form.Check
                inline
                ...
                checked={!formData.hasFloorHeating}
                onChange={() =>
                  setFormData({ ...formData, hasFloorHeating: false })
                }
              />
            </div>
                ...
                <div className="form-group">
                  ...
                  <div className="input-with-sqrt">
                    ...
                    <input
                      ...
                      value={formData.floorHeatingSquareMeters}
                      onChange={handleChange}
                    />
                  </div>
                  <span className="error-message">
          ...
          <>
            ...
            <div className="form-group text-center">
              ...
              <Form.Check
                ...
                onChange={() =>
                  setFormData({ ...formData, hasElectricCar: true })
                }
              />
              <Form.Check
                inline
                ...
                checked={!formData.hasElectricCar}
                onChange={() =>
                  setFormData({ ...formData, hasElectricCar: false })
                }
              />
            </div>
            {formData.hasElectricCar && (
              <>
                <div className="form-group">
                  <label className="cars-label">
                    {t("NumberOfElectricCars")}
                  </label>
                  <div className="input-with-cars">
                    ...
                    <input
                      ...
                      value={formData.electricCarCount}
                      onChange={handleChange}
                    />
                  </div>
                  <span className="error-message">
                ...
                <div className="form-group">
                  ...
                  <div className="input-with-kwh">
                    ...
                    <input
                      ...
                      value={formData.electricCarKwhUsagePerYear}
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      placement="right"
                      ...
                      <span className="error-message">
                        {
                          validationErrors.find(
                            (error) =>
                              error.field === "electricCarKwhUsagePerYear"
                          )?.message
                        }
                      </span>
                    )}
              ...
              <div className="form-group">
                ...
                <div className="input-with-sauna">
                  ...
                  <input
                    ...
                    value={formData.saunaHeatingFrequency}
                    onChange={handleChange}
                  />
                </div>
                <span className="error-message">
              ...
              <>
                <div className="form-group text-center">
                  ...
                  <Form.Check
                    ...
                    onChange={() =>
                      setFormData({ ...formData, hasFirePlace: true })
                    }
                  />
                  <Form.Check
                    inline
                    ...
                    checked={!formData.hasFirePlace}
                    onChange={() =>
                      setFormData({ ...formData, hasFirePlace: false })
                    }
                  />
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-with-fireplace">
                      ...
                      <input
                        ...
                        value={formData.firePlaceHeatingFrequency}
                        onChange={handleChange}
                      />
                    </div>
                    <span className="error-message">
            ...
            <>
              ...
              <div className="form-group text-center">
                ...
                <Form.Check
                  ...
                  onChange={() =>
                    setFormData({ ...formData, hasSolarPanels: true })
                  }
                />
                <Form.Check
                  inline
                  ...
                  checked={!formData.hasSolarPanels}
                  onChange={() =>
                    setFormData({ ...formData, hasSolarPanels: false })
                  }
                />
              </div>
              {formData.hasSolarPanels && (
                <div className="form-group">
                  <label className="solarpanel-label">
                    {t("SolarPanelCount")}
                  </label>
  ...
  const renderChart = (): React.ReactNode => {
    ...
    const labels = filteredData.map((month, index) => {
      let monthName;
      if (i18n.language === "en") {
        monthName = new Date(0, month.Month - 1).toLocaleString("en-US", {
          month: "long",
        });
      } else if (i18n.language === "fi") {
        monthName = new Date(0, month.Month - 1).toLocaleString("fi-FI", {
          month: "long",
        });
      }
        ...
        {showProgressBar && (
          <div className="progress-bar-container">
            <CircularProgressbar
              ...
              text={`${Math.round(
                calculateProgressBar(currentStep, totalSteps)
              )}%`}
              styles={buildStyles({
                pathColor: "#808080",
                textColor: "black",
        ...
        <>
          <div className="result-data-container">
            <div className="result-data-summary">
              <h3>{t("results")}</h3>
              <p>
                {t("resultDescription")} <b>{result.CalculationYears}</b>
              </p>
              <p>
                {t("cheaperOptionDescription")}{" "}
                <b>
                  {result.CheaperOption === "Spot price"
                    ? t("spotElectricity")
                    : t("fixedElectricity") + ""}
                </b>
              </p>
              <p className="price-difference">
                {t("averagepriceDifference")} {result.CostDifference}€
              </p>
            </div>
            <div className="result-data-keywords">
              <p>
                {t("directiveConsumption")}{" "}
                <span className="dynamic-value">
                  {result.EstimatedMinConsumption} -{" "}
                  {result.EstimatedMaxConsumption}
                </span>{" "}
                kWh
              </p>
              <p>
                {t("spotElectricityPrice")}{" "}
                <span className="dynamic-value">
                  {result.MinSpotPriceCost} - {result.MaxSpotPriceCost}
                </span>{" "}
                €
              </p>
              <p>
                {t("fixedElectricityPrice")}{" "}
                <span className="dynamic-value">
                  {result.MinFixedPriceCost} - {result.MaxFixedPriceCost}
                </span>{" "}
                €
              </p>
              <p>
                {t("estimatedAverageHourlySpotPrice")}{" "}
                <span className="dynamic-value">
                  {result.AverageHourlySpotPrice}
                </span>{" "}
                c/kWh
              </p>
            </div>
            ...
            {isMobile() && (
              <div className="month-period-controls">
                ...
                <Button
                  ...
                  disabled={
                    currentMonthIndex + (isMobile() ? 6 : 15) >=
                    (result?.MonthlyData?.length || 0)
                  }
                >
                  {t("next")}
