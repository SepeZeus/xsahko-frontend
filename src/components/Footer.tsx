...
const Footer = () => {
  ...
  const handleClickOutside = (event: MouseEvent) => {
    if (
      githubDropdownRef.current &&
      !githubDropdownRef.current.contains(event.target as Node)
    ) {
    ...
    <footer className="footer w-100">
      <Container fluid>
        ...
        <Row className="justify-content-center mt-3">
          <Col md={6} className="text-center">
            <div className="footer-links">
              ...
              <a
                href="https://www.youtube.com/channel/UC0hDPOZXMUxd51l0CA9noJg"
              ...
              <a
                href="https://www.linkedin.com/school/xamk"
                className="text-white"
              >
                <span className="footer-icon-container">
        ...
        <Row className="justify-content-center mt-3">
          <Col md={6} className="text-center">
            <p className="text-white mb-0">
              {t("DataResource")}{" "}
              <a
                href="https://www.entsoe.eu/data/transparency-platform/"
                className="text-white"
              >
                Entso-E
              </a>
        ...
        <Row className="justify-content-center mt-3">
          <Col md={6} className="text-center">
            <p className="text-white mb-0">
              <a href="/privacy-notice" className="text-white">
                {t("privacy.header0")}
              </a>{" "}
              {/* Privacy Policy */}
            </p>
