...
export const ValidateFormData = (
  ...
  if (currentStep === 1) {
    ...
    if (formData.directiveFixedPrice <= 0) {
      errors.push({
        field: "directiveFixedPrice",
        message: t("FixedPriceError"),
      });
    }
  }
  ...
  if (currentStep === 3) {
    ...
    if (formData.numberOfResidents <= 0) {
      errors.push({
        ...
        message: t("NumberOfResidentsError"),
      });
    }
  }
  ...
  if (formData.hasSauna && !formData.saunaHeatingFrequency) {
    errors.push({
      field: "saunaHeatingFrequency",
      message: t("SaunaUsageError"),
    });
  }

  if (formData.hasSauna) {
    if (
      !formData.saunaHeatingFrequency ||
      formData.saunaHeatingFrequency <= 0
    ) {
      errors.push({
        field: "saunaHeatingFrequency",
        message: t("SaunaUsageError"),
  ...
  if (formData.hasFirePlace && !formData.firePlaceHeatingFrequency) {
    errors.push({
      field: "firePlaceHeatingFrequency",
      message: t("FirePlaceUsageError"),
    });
  }

  if (formData.hasFirePlace) {
    if (
      !formData.firePlaceHeatingFrequency ||
      formData.firePlaceHeatingFrequency <= 0
    ) {
      errors.push({
        field: "firePlaceHeatingFrequency",
        message: t("FirePlaceUsageError"),
  ...
  if (formData.hasElectricCar) {
    if (!formData.electricCarCount || formData.electricCarCount <= 0) {
      errors.push({
        field: "electricCarCount",
        message: t("NumberOfElectricCarsError"),
      });
    }

    if (
      !formData.electricCarKwhUsagePerYear ||
      formData.electricCarKwhUsagePerYear <= 0
    ) {
      errors.push({
        field: "electricCarKwhUsagePerYear",
        message: t("ElectricCarUsageError"),
      });
    }
  }
  ...
  if (currentStep === 5 && formData.hasFloorHeating) {
    if (
      formData.floorHeatingSquareMeters === undefined ||
      formData.floorHeatingSquareMeters === null
    ) {
      errors.push({
        field: "floorHeatingSquareMeters",
        message: t("FloorHeatingEmptyError"),
      });
    } else if (formData.floorHeatingSquareMeters <= 0) {
      errors.push({
        field: "floorHeatingSquareMeters",
        message: t("FloorHeatingError"),
      });
    }
  }
  ...
  if (
    ...
    (formData.houseType === "Cottage" && formData.hasSolarPanels === true)
  ) {
    if (!formData.solarPanelCount || formData.solarPanelCount <= 0) {
      errors.push({
        field: "solarPanelCount",
        message: t("SolarPanelCountError"),
      });
    }
  }
